...
- **Versión:** v1.0.0
- **Estado:** propuesta (próxima fecha se define en el grupo)
...
Nos reunimos (idealmente un sábado al mes) para compartir un **apthapi** y sostener tareas simples que cuidan el Barranco.

- **Yoga previo es opcional:** puedes venir solo a comer, solo a ayudar, o solo a compartir.
- Co‑creamos entre todos, con conciencia y sentido común.
- Cerramos el bloque comunitario a las **2:00pm**.
- Dejamos el lugar listo para abrir al público y también disfrutamos el espacio.
- La próxima fecha se define y coordina en el grupo.

---

## 1) Qué es

Un encuentro del Voluntariado Barranco para cocinar/compartir comida, conversar ideas, y realizar tareas ligeras pero constantes que ayudan al Proyecto Cultural Barranco a operar mejor.

La idea es que sea una actividad simple y adoptable: funciona con 5 personas y también con 30.

---

## 2) Cuándo y dónde

- **Frecuencia:** inicialmente 1 sábado al mes (fecha se define en el grupo)
- **Rango horario base:**
...
- compartimos comida (apthapi)
- conversamos y aterrizamos ideas
- hacemos tareas rápidas (ver sección 5)
...
- barrer
- lavar platos/vasos
- inventario de barra reducida (si corresponde ese sábado)
...
- Funciona perfecto con pocos: si somos 5, se hace igual. El tamaño del grupo se ajusta orgánicamente.
- Cambiar de chip ayuda: no “servicio”, sino co‑creación (cada uno se atiende y también aporta).
...
- Uno es libre de llegar e irse cuando quiera. Lo importante es sostener el acuerdo de conciencia y cuidado.
